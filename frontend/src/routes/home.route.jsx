...
import AnomalyAnalyzer from "../components/anomaly-analyzer.component";
...
import VisualsSamePage from "../components/visuals-same-page.components";
...
const Home = () => {
    ...
    const [isAnomalyAnalyzerOpen,setIsAnomalyAnalyzerOpen]=useState(false);
    ...
    const handleAnomalyClick=(log)=>{
        setCurrentAnomaly(log)
    }
    ...
    return ( 
        <div className="p-2 flex flex-col gap-2">
            <Header heading={'System Logs Dashboard'} label={'Real-time monitoring of system processes'} isSideIconRequired={false} />
            ...
            <div>
                ...
                <div className="p-1 flex border w-full h-full">
                    <div className="p-1 flex flex-col transition-all duration-300 flex-grow ease-in-out">
                        <div className="h-[520px]">
                            <div className="flex gap-2">
                                <AnamolyControlOptions isAnomalyAnalyzerOpen={isAnomalyAnalyzerOpen} setIsAnomalyAnalyzerOpen={setIsAnomalyAnalyzerOpen} />
                                <AnamolyEventInputSelect/>
                            </div>
                            <div className="p-2 h-[420px] overflow-y-auto">
                                <AnomalyTable anomalyLogs={filteredAnomalies} handleLogClick={handleAnomalyClick} />
                            </div>
                        </div>
                        <div className=" grow p-1 grid gap-2 grid-cols-[repeat(auto-fit,minmax(270px,1fr))]">
                ...
                <AnomalyAnalyzer isAnomalyAnalyzerOpen={isAnomalyAnalyzerOpen} currentAnomaly={currentAnomaly} />
                </div>
            </div>
            <div>
                <Header isSideIconRequired={false} heading={'Visualizations'} label={'Real-time Visualizations'} />
                <VisualsSamePage/>
            </div>
        </div>
     );
