import EventTimelineChart from "./visual-components/event-timeline-chart.component";
import EventCountBarChart from "./visual-components/event-count-bar-chart.component";
import { useLogsContext } from "../contexts/logs-context.context";
import AnomalyDonutChart from "./visual-components/anomaly-donut-chart.component";
import TopProcessesBarChart from "./visual-components/top-processes-bar-chart.component";
import AnomalyDensityAreaChart from "./visual-components/anomaly-density-area-chart.component";
import { useMemo } from "react";
const VisualsSamePage=()=>{
...
export default VisualsSamePage;